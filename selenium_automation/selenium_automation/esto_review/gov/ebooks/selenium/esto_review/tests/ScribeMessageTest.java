...
public class ScribeMessageTest {
	...
	private String UserName = "gkopp";
	private String Password = "rev_qa";
	
	private String UserName1 = "sozog";
	private String Password1 = "rev_qa";
...
//	
//	@Test(priority=7)
//	public void sendScribeMessage() throws InterruptedException{
//		boolean sendScribeMessage = scribePage.sendScribeMessage();		
//		Helper.ShowTestResult("**7. Verification of scribe send Scribe Message.", sendScribeMessage);
//		DataManager.SaveTestResult("Verification of scribe send Scribe Message.", sendScribeMessage? "Passed" : "Failed", "Test Execution Completed Successfully!");
//	}
//	
//	@Test(priority=8)
//	public void scribeLogout() throws InterruptedException{
//		boolean scribeLogout = leadReviewer.logout();
//		Helper.ShowTestResult("**8. Verification of quality control logout.", scribeLogout);
...
//	}
	...
	@Test(priority=9)
	public void ESTOLogin2() throws InterruptedException {
		boolean ESTOReviewLoginPage = commonMethodsPages.ESTOLogin(UserName1, Password1);
		Helper.ShowTestResult("**9. Verification of ESTO Review Login.", ESTOReviewLoginPage);
		DataManager.SaveTestResult("Verification of ESTO Review Login.", ESTOReviewLoginPage? "Passed" : "Failed", "Test Execution Completed Successfully!");
	    }
	
	@Test(priority=10)
	public void SelectACT17Solicitation1(){
		boolean	selectSoliciation = commonMethodsESTOReviewPages.SelectACT17Solicitation();
		Helper.ShowTestResult("**10. Verification of select soliciation window.", selectSoliciation);
		DataManager.SaveTestResult("Verification of select soliciation window.", selectSoliciation? "Passed" : "Failed", "Test Execution Completed Successfully!");
	    
	}
	
	@Test(priority=11)
	public void clickSelectSolicitationButton1(){
		boolean clickSelectSolicitation = commonMethodsESTOReviewPages.ClickSelectSolicitationButton();	
		Helper.ShowTestResult("**11. Verification of click soliciation.", clickSelectSolicitation);
		DataManager.SaveTestResult("Verification of click soliciation.", clickSelectSolicitation? "Passed" : "Failed", "Test Execution Completed Successfully!");
	}
	
	
	@Test(priority=12)
	public void searchProposal1() throws InterruptedException{
		boolean searchProposal = commonMethodsESTOReviewPages.SearchByProposalNumber();
		Helper.ShowTestResult("**12. Verification of search proposal.", searchProposal);
		DataManager.SaveTestResult("Verification of search proposal.", searchProposal? "Passed" : "Failed", "Test Execution Completed Successfully!");
	}
	
	@Test(priority=13)
	public void toggle1() throws InterruptedException{
		boolean toggleProposal = qualityControlPage.toggle();	
		Helper.ShowTestResult("**13. Verification of proposal toggle.", toggleProposal);
		DataManager.SaveTestResult("Verification of proposal toggle.", toggleProposal? "Passed" : "Failed", "Test Execution Completed Successfully!");
	}
	
	@Test(priority=14)
	public void scribeNotesLink() throws InterruptedException{
		boolean scribeNotesLink = scribePage.scribeNotesLink();	
		Helper.ShowTestResult("**14. Verification of scribeNotes Link.", scribeNotesLink);
		DataManager.SaveTestResult("Verification of scribeNotes Link.", scribeNotesLink? "Passed" : "Failed", "Test Execution Completed Successfully!");
	}
	
	@Test(priority=15)
	public void verifyScribeMessage() throws InterruptedException{
		boolean verifyScribeMessage = scribePage.appendScribeMessage();		
		Helper.ShowTestResult("**15. Verification of verify Scribe Message.", verifyScribeMessage);
		DataManager.SaveTestResult("Verification of verify Scribe Message.", verifyScribeMessage? "Passed" : "Failed", "Test Execution Completed Successfully!");
	}
	
//	@Test(priority=16)
//	public void verifyUpdateScibeNotes() throws InterruptedException{
//		boolean UpdateScibeNotesPage = scribePage.verifyScibeNotes();		
//		Helper.ShowTestResult("**16. Verification of update scribe notes page.", UpdateScibeNotesPage);
