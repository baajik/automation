...
public class PM_DownloadNDATest {
...
*/
	...
	public void test1() 
	{
		...
		//Import data from excel
			...
			PM_DownloadNDAPage.NavigateToDownloadNDA();
			
			PM_DownloadNDAPage.DownloadSingleNDA();
			
			PM_DownloadNDAPage.DownloadAllNDAs();
			
			String LastName = "Wdowinski";
			PM_DownloadNDAPage.SearchByFunction(LastName);
			
			CommonMethodsESTOReviewPages.ClosePopUp();
